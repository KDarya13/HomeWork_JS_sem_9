...
fromElem.addEventListener('input', () => {
    spanElem.innerText = fromElem.value;
})
...
- Если поле было чем-либо заполнено, подсветку (класс error) необходимо убрать.*/
    ...
    const firstInput = document.querySelectorAll('form input');
    const secondInput = document.querySelectorAll('form select');
    const sendBtn = document.getElementById('send');
    let controlError = document.getElementsByClassName('.error');
